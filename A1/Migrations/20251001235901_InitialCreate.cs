        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomeApp = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParceirosApp", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SugestoesDiarias", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Atendimentos_ParceirosApp_ParceiroAppId",
                        column: x => x.ParceiroAppId,
                        principalTable: "ParceirosApp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Atendimentos_ParceiroAppId",
                table: "Atendimentos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SugestoesDiarias_Data_Periodo",
                table: "SugestoesDiarias",
                columns: new[] { "Data", "Periodo" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SugestoesDiarias_ItemCardapioId",
                table: "SugestoesDiarias",
                column: "ItemCardapioId");
        }
